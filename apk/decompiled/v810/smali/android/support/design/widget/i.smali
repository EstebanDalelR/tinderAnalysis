...
.field final n:Landroid/support/design/widget/y;
...
.method constructor <init>(Landroid/support/design/widget/y;Landroid/support/design/widget/n;)V
    .locals 3
    ...
    .line 90
    iput-object p1, p0, Landroid/support/design/widget/i;->n:Landroid/support/design/widget/y;
    ...
    iput-object v0, p0, Landroid/support/design/widget/i;->p:Landroid/support/design/widget/p;
    ...
    .line 97
    invoke-direct {p0, v2}, Landroid/support/design/widget/i;->a(Landroid/support/design/widget/i$e;)Landroid/animation/ValueAnimator;
    ...
    new-instance v2, Landroid/support/design/widget/i$d;

    invoke-direct {v2, p0}, Landroid/support/design/widget/i$d;-><init>(Landroid/support/design/widget/i;)V
    ...
    .line 107
    iget-object v0, p0, Landroid/support/design/widget/i;->n:Landroid/support/design/widget/y;
...
.method private static b(I)Landroid/content/res/ColorStateList;
    ...
    .line 492
    sget-object v3, Landroid/support/design/widget/i;->j:[I
...
.method private q()V
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/y;->getLayerType()I
    ...
    invoke-virtual {v0, v2, v3}, Landroid/support/design/widget/y;->setLayerType(ILandroid/graphics/Paint;)V
    ...
    invoke-virtual {v0, v1, v3}, Landroid/support/design/widget/y;->setLayerType(ILandroid/graphics/Paint;)V
...
.method a(ILandroid/content/res/ColorStateList;)Landroid/support/design/widget/d;
    ...
    .line 347
    invoke-virtual {p0}, Landroid/support/design/widget/i;->i()Landroid/support/design/widget/d;
...
.method a(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;II)V
    ...
    iget-object v1, p0, Landroid/support/design/widget/i;->n:Landroid/support/design/widget/y;

    .line 140
    invoke-virtual {v1}, Landroid/support/design/widget/y;->getContext()Landroid/content/Context;

    move-result-object v1

    iget-object v2, p0, Landroid/support/design/widget/i;->g:Landroid/graphics/drawable/Drawable;

    iget-object v3, p0, Landroid/support/design/widget/i;->o:Landroid/support/design/widget/n;
    ...
    iput-object v0, p0, Landroid/support/design/widget/i;->c:Landroid/support/design/widget/m;
    ...
    iget-object v1, p0, Landroid/support/design/widget/i;->c:Landroid/support/design/widget/m;
...
.method a(Landroid/support/design/widget/i$c;Z)V
    ...
    :goto_1
    invoke-virtual {v1, v0, p2}, Landroid/support/design/widget/y;->a(IZ)V
...
.method i()Landroid/support/design/widget/d;
    .locals 1
...
.method m()Z
    ...
    .line 394
    iget-object v2, p0, Landroid/support/design/widget/i;->n:Landroid/support/design/widget/y;

    invoke-virtual {v2}, Landroid/support/design/widget/y;->getVisibility()I
    ...
    .line 396
    iget v2, p0, Landroid/support/design/widget/i;->b:I
