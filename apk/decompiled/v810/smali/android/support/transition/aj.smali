...
.method private static a(Landroid/animation/LayoutTransition;)V
    ...
    .line 116
    sget-boolean v0, Landroid/support/transition/aj;->e:Z
    ...
    sput-object v0, Landroid/support/transition/aj;->d:Ljava/lang/reflect/Method;

    .line 119
    sget-object v0, Landroid/support/transition/aj;->d:Ljava/lang/reflect/Method;
    ...
    .line 123
    :goto_0
    sput-boolean v3, Landroid/support/transition/aj;->e:Z
...
# virtual methods
.method public a(Landroid/view/ViewGroup;)Landroid/support/transition/ah;
    .locals 1

    .prologue
    .line 46
    invoke-static {p1}, Landroid/support/transition/af;->a(Landroid/view/ViewGroup;)Landroid/support/transition/af;
...
.method public a(Landroid/view/ViewGroup;Z)V
    ...
    .line 52
    sget-object v1, Landroid/support/transition/aj;->a:Landroid/animation/LayoutTransition;

    if-nez v1, :cond_0

    .line 53
    new-instance v1, Landroid/support/transition/aj$1;

    invoke-direct {v1, p0}, Landroid/support/transition/aj$1;-><init>(Landroid/support/transition/aj;)V

    sput-object v1, Landroid/support/transition/aj;->a:Landroid/animation/LayoutTransition;
    ...
    .line 70
    invoke-static {v0}, Landroid/support/transition/aj;->a(Landroid/animation/LayoutTransition;)V
    ...
    .line 77
    :cond_2
    sget-object v0, Landroid/support/transition/aj;->a:Landroid/animation/LayoutTransition;
    ...
    .line 82
    sget-boolean v1, Landroid/support/transition/aj;->c:Z
    ...
    sput-object v1, Landroid/support/transition/aj;->b:Ljava/lang/reflect/Field;

    .line 85
    sget-object v1, Landroid/support/transition/aj;->b:Ljava/lang/reflect/Field;
    ...
    .line 89
    :goto_1
    sput-boolean v4, Landroid/support/transition/aj;->c:Z
