...
.method a(Ljava/lang/String;ZZ)Landroid/support/v4/app/v;
    ...
    .prologue
    .line 305
    iget-object v0, p0, Landroid/support/v4/app/l;->f:Landroid/support/v4/f/n;
    ...
    iput-object v0, p0, Landroid/support/v4/app/l;->f:Landroid/support/v4/f/n;
    ...
    .line 311
    iget-object v1, p0, Landroid/support/v4/app/l;->f:Landroid/support/v4/f/n;
...
.method a(Landroid/support/v4/f/n;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 355
    invoke-virtual {p1, v1}, Landroid/support/v4/f/n;->c(I)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Landroid/support/v4/app/v;

    invoke-virtual {v0, p0}, Landroid/support/v4/app/v;->a(Landroid/support/v4/app/l;)V
    ...
    .line 358
    :cond_0
    iput-object p1, p0, Landroid/support/v4/app/l;->f:Landroid/support/v4/f/n;
...
.method l()Landroid/support/v4/app/v;
    ...
    .line 214
    :cond_0
    iput-boolean v2, p0, Landroid/support/v4/app/l;->i:Z
    ...
    invoke-virtual {p0, v0, v1, v2}, Landroid/support/v4/app/l;->a(Ljava/lang/String;ZZ)Landroid/support/v4/app/v;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/app/l;->h:Landroid/support/v4/app/v;
...
.method n()V
    ...
    :cond_1
    :goto_1
    iput-boolean v3, p0, Landroid/support/v4/app/l;->i:Z
...
.method q()Landroid/support/v4/f/n;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/f/n;->c(I)Ljava/lang/Object;
    ...
    .line 331
    iget-boolean v6, v5, Landroid/support/v4/app/v;->f:Z
    ...
    .line 333
    invoke-virtual {v5}, Landroid/support/v4/app/v;->b()V
    ...
    .line 340
    :cond_3
    invoke-virtual {v5}, Landroid/support/v4/app/v;->h()V

    .line 341
    iget-object v6, p0, Landroid/support/v4/app/l;->f:Landroid/support/v4/f/n;

    iget-object v5, v5, Landroid/support/v4/app/v;->d:Ljava/lang/String;

    invoke-virtual {v6, v5}, Landroid/support/v4/f/n;->remove(Ljava/lang/Object;)Ljava/lang/Object;
