...
.field mListener:Landroid/support/v4/view/y;

.field private final mProxyListener:Landroid/support/v4/view/z;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;->mProxyListener:Landroid/support/v4/view/z;
...
.method public play(Landroid/support/v4/view/x;)Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;
    .locals 1
...
.method public playSequentially(Landroid/support/v4/view/x;Landroid/support/v4/view/x;)Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;
    .locals 2
    ...
    .line 61
    invoke-virtual {p1}, Landroid/support/v4/view/x;->a()J

    move-result-wide v0

    invoke-virtual {p2, v0, v1}, Landroid/support/v4/view/x;->b(J)Landroid/support/v4/view/x;
...
.method public setListener(Landroid/support/v4/view/y;)Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;
    .locals 1
    ...
    .line 114
    iput-object p1, p0, Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;->mListener:Landroid/support/v4/view/y;
...
.method public start()V
    ...
    .line 75
    :cond_2
    iget-object v2, p0, Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;->mListener:Landroid/support/v4/view/y;

    if-eqz v2, :cond_3

    .line 76
    iget-object v2, p0, Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;->mProxyListener:Landroid/support/v4/view/z;
