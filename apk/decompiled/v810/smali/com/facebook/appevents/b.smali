...
.method private declared-synchronized b(Lcom/facebook/appevents/AccessTokenAppIdPair;)Lcom/facebook/appevents/f;
    ...
    .line 86
    invoke-static {v1}, Lcom/facebook/appevents/AppEventsLogger;->a(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v1

    invoke-direct {v0, v2, v1}, Lcom/facebook/appevents/f;-><init>(Lcom/facebook/internal/a;Ljava/lang/String;)V
...
.method public declared-synchronized a(Lcom/facebook/appevents/PersistedEvents;)V
    ...
    .line 46
    invoke-virtual {p1, v0}, Lcom/facebook/appevents/PersistedEvents;->a(Lcom/facebook/appevents/AccessTokenAppIdPair;)Ljava/util/List;
