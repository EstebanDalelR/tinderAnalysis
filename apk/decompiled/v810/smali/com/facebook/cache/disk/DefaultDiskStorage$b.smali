...
.method private constructor <init>(Ljava/lang/String;Ljava/io/File;)V
    ...
    .line 518
    invoke-static {p2}, Lcom/facebook/binaryresource/b;->a(Ljava/io/File;)Lcom/facebook/binaryresource/b;

    move-result-object v0

    iput-object v0, p0, Lcom/facebook/cache/disk/DefaultDiskStorage$b;->b:Lcom/facebook/binaryresource/b;
...
.method public c()Lcom/facebook/binaryresource/b;
    .locals 1
...
.method public d()J
    ...
    invoke-virtual {v0}, Lcom/facebook/binaryresource/b;->b()J
