...
.method public static a()Lcom/facebook/imagepipeline/memory/r;
    ...
    .line 50
    invoke-static {}, Lcom/facebook/imagepipeline/memory/e;->b()I

    move-result v2

    sget-object v3, Lcom/facebook/imagepipeline/memory/e;->a:Landroid/util/SparseIntArray;

    invoke-direct {v0, v1, v2, v3}, Lcom/facebook/imagepipeline/memory/r;-><init>(IILandroid/util/SparseIntArray;)V
