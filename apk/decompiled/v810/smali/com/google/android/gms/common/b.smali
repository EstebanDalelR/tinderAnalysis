...
.method public static a(Landroid/app/Activity;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-static {p0, v0}, Lcom/google/android/gms/common/internal/bb;->c(Landroid/content/Context;I)Ljava/lang/String;
...
.method static a(Landroid/content/Context;ILcom/google/android/gms/common/internal/bc;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    .locals 5
    ...
    :cond_2
    invoke-static {p0, p1}, Lcom/google/android/gms/common/internal/bb;->c(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_3
    invoke-static {p0, p1}, Lcom/google/android/gms/common/internal/bb;->e(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_4
    invoke-static {p0, p1}, Lcom/google/android/gms/common/internal/bb;->a(Landroid/content/Context;I)Ljava/lang/String;
...
.method public static a(Landroid/content/Context;Lcom/google/android/gms/common/api/internal/bc;)Lcom/google/android/gms/common/api/internal/bb;
    .locals 2
    ...
    invoke-direct {v0, p1}, Lcom/google/android/gms/common/api/internal/bb;-><init>(Lcom/google/android/gms/common/api/internal/bc;)V

    invoke-virtual {p0, v0, v1}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;

    invoke-virtual {v0, p0}, Lcom/google/android/gms/common/api/internal/bb;->a(Landroid/content/Context;)V

    const-string v1, "com.google.android.gms"

    invoke-static {p0, v1}, Lcom/google/android/gms/common/p;->zzv(Landroid/content/Context;Ljava/lang/String;)Z

    move-result v1

    if-nez v1, :cond_0

    invoke-virtual {p1}, Lcom/google/android/gms/common/api/internal/bc;->a()V
...
.method static a(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
    ...
    invoke-virtual {v1, v0, p2}, Lcom/google/android/gms/common/c;->show(Landroid/support/v4/app/m;Ljava/lang/String;)V
...
.method private final a(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
    ...
    :cond_2
    invoke-static {p1, p2}, Lcom/google/android/gms/common/internal/bb;->b(Landroid/content/Context;I)Ljava/lang/String;

    move-result-object v0

    invoke-static {p1, p2}, Lcom/google/android/gms/common/internal/bb;->d(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-static {v3}, Lcom/google/android/gms/common/internal/ae;->a(Z)V
    ...
    invoke-virtual {v3, v2}, Landroid/support/v4/app/y$d;->c(Ljava/lang/CharSequence;)Landroid/support/v4/app/y$d;
    ...
    invoke-virtual {v2, v4, v5}, Landroid/support/v4/app/y$d;->a(J)Landroid/support/v4/app/y$d;

    move-result-object v2

    invoke-virtual {v2, v6}, Landroid/support/v4/app/y$d;->a(Z)Landroid/support/v4/app/y$d;

    move-result-object v2

    invoke-virtual {v2, p4}, Landroid/support/v4/app/y$d;->a(Landroid/app/PendingIntent;)Landroid/support/v4/app/y$d;
    ...
    invoke-virtual {v0, v6}, Landroid/support/v4/app/y$d;->b(Z)Landroid/support/v4/app/y$d;
    ...
    sget-object v1, Lcom/google/android/gms/common/p;->zzfjd:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public a(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-static {p1, p2, v0}, Lcom/google/android/gms/common/g;->a(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;

    move-result-object v0

    invoke-static {p1, v0, p3}, Lcom/google/android/gms/common/internal/bc;->a(Landroid/app/Activity;Landroid/content/Intent;I)Lcom/google/android/gms/common/internal/bc;

    move-result-object v0

    invoke-static {p1, p2, v0, p4}, Lcom/google/android/gms/common/b;->a(Landroid/content/Context;ILcom/google/android/gms/common/internal/bc;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
...
.method public a(Landroid/content/Context;Lcom/google/android/gms/common/ConnectionResult;)Landroid/app/PendingIntent;
    ...
    invoke-virtual {p0, p1, v0, v1}, Lcom/google/android/gms/common/g;->a(Landroid/content/Context;II)Landroid/app/PendingIntent;
...
.method public a(Landroid/content/Context;I)V
    ...
    invoke-virtual {p0, p1, p2, v0, v1}, Lcom/google/android/gms/common/g;->a(Landroid/content/Context;IILjava/lang/String;)Landroid/app/PendingIntent;
...
.method public final a(Landroid/app/Activity;Lcom/google/android/gms/common/api/internal/bg;IILandroid/content/DialogInterface$OnCancelListener;)Z
    .locals 2

    const-string v0, "d"

    invoke-static {p1, p3, v0}, Lcom/google/android/gms/common/g;->a(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;

    move-result-object v0

    const/4 v1, 0x2

    invoke-static {p2, v0, v1}, Lcom/google/android/gms/common/internal/bc;->a(Lcom/google/android/gms/common/api/internal/bg;Landroid/content/Intent;I)Lcom/google/android/gms/common/internal/bc;

    move-result-object v0

    invoke-static {p1, p3, v0, p5}, Lcom/google/android/gms/common/b;->a(Landroid/content/Context;ILcom/google/android/gms/common/internal/bc;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
