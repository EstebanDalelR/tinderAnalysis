...
.field private static zzfiz:Z

.field private static zzfja:Z

.field private static zzfjb:Z

.field private static zzfjc:Z

.field static final zzfjd:Ljava/util/concurrent/atomic/AtomicBoolean;

.field private static final zzfje:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method static constructor <clinit>()V
    ...
    sput v0, Lcom/google/android/gms/common/p;->GOOGLE_PLAY_SERVICES_VERSION_CODE:I

    sput-boolean v1, Lcom/google/android/gms/common/p;->zzfiz:Z

    sput-boolean v1, Lcom/google/android/gms/common/p;->zzfja:Z

    sput-boolean v1, Lcom/google/android/gms/common/p;->zzfjb:Z

    sput-boolean v1, Lcom/google/android/gms/common/p;->zzfjc:Z

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Lcom/google/android/gms/common/p;->zzfjd:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Lcom/google/android/gms/common/p;->zzfje:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static getErrorPendingIntent(ILandroid/content/Context;I)Landroid/app/PendingIntent;
    ...
    invoke-virtual {v0, p1, p0, p2}, Lcom/google/android/gms/common/g;->a(Landroid/content/Context;II)Landroid/app/PendingIntent;
...
.method public static isGooglePlayServicesAvailable(Landroid/content/Context;)I
    ...
    sget-object v3, Lcom/google/android/gms/common/p;->zzfje:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :cond_0
    sget v4, Lcom/google/android/gms/common/p;->GOOGLE_PLAY_SERVICES_VERSION_CODE:I

    if-eq v3, v4, :cond_1

    new-instance v0, Ljava/lang/IllegalStateException;

    sget v1, Lcom/google/android/gms/common/p;->GOOGLE_PLAY_SERVICES_VERSION_CODE:I
    ...
    invoke-static {p0}, Lcom/google/android/gms/common/util/g;->d(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, Lcom/google/android/gms/common/q;->a(Landroid/content/Context;)Lcom/google/android/gms/common/q;

    if-eqz v4, :cond_5

    sget-object v4, Lcom/google/android/gms/common/l;->a:[Lcom/google/android/gms/common/i;

    invoke-static {v3, v4}, Lcom/google/android/gms/common/q;->a(Landroid/content/pm/PackageInfo;[Lcom/google/android/gms/common/i;)Lcom/google/android/gms/common/i;
    ...
    :cond_4
    new-array v4, v1, [Lcom/google/android/gms/common/i;

    aput-object v3, v4, v2

    invoke-static {v6, v4}, Lcom/google/android/gms/common/q;->a(Landroid/content/pm/PackageInfo;[Lcom/google/android/gms/common/i;)Lcom/google/android/gms/common/i;
    ...
    invoke-static {v6, v3}, Lcom/google/android/gms/common/q;->a(Landroid/content/pm/PackageInfo;[Lcom/google/android/gms/common/i;)Lcom/google/android/gms/common/i;
    ...
    :cond_6
    sget v0, Lcom/google/android/gms/common/p;->GOOGLE_PLAY_SERVICES_VERSION_CODE:I
...
.method public static zzbn(Landroid/content/Context;)V
    ...
    invoke-static {p0, v0, v1}, Lcom/google/android/gms/common/g;->a(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;
...
.method public static zzcc(Landroid/content/Context;)V
    ...
    sget-object v0, Lcom/google/android/gms/common/p;->zzfjd:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static zzcf(Landroid/content/Context;)Z
    ...
    sget-boolean v2, Lcom/google/android/gms/common/p;->zzfjc:Z
    ...
    new-array v3, v3, [Lcom/google/android/gms/common/i;

    const/4 v4, 0x0

    sget-object v5, Lcom/google/android/gms/common/l;->a:[Lcom/google/android/gms/common/i;
    ...
    invoke-static {v2, v3}, Lcom/google/android/gms/common/q;->a(Landroid/content/pm/PackageInfo;[Lcom/google/android/gms/common/i;)Lcom/google/android/gms/common/i;
    ...
    sput-boolean v2, Lcom/google/android/gms/common/p;->zzfjb:Z
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :cond_0
    :goto_1
    sget-boolean v2, Lcom/google/android/gms/common/p;->zzfjb:Z
...
.method public static zze(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, v0}, Lcom/google/android/gms/common/p;->zzv(Landroid/content/Context;Ljava/lang/String;)Z
