...
.method private static b(Landroid/content/Context;Landroid/os/Bundle;)V
    ...
    .line 341
    :cond_4
    invoke-static {p0, p1}, Lcom/leanplum/Leanplum$12;->a(Landroid/content/Context;Landroid/os/Bundle;)Landroid/support/v4/app/y$d;
    ...
    invoke-virtual {v10, v0}, Landroid/support/v4/app/y$d;->a(I)Landroid/support/v4/app/y$d;

    .line 354
    :goto_1
    invoke-virtual {v10, v3}, Landroid/support/v4/app/y$d;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/y$d;

    move-result-object v0

    new-instance v1, Landroid/support/v4/app/y$c;

    invoke-direct {v1}, Landroid/support/v4/app/y$c;-><init>()V

    .line 356
    invoke-virtual {v1, v4}, Landroid/support/v4/app/y$c;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/y$c;
    ...
    .line 357
    invoke-virtual {v0, v4}, Landroid/support/v4/app/y$d;->b(Ljava/lang/CharSequence;)Landroid/support/v4/app/y$d;
    ...
    .line 367
    :cond_6
    new-instance v1, Landroid/support/v4/app/y$b;

    invoke-direct {v1}, Landroid/support/v4/app/y$b;-><init>()V

    .line 368
    invoke-virtual {v1, v5}, Landroid/support/v4/app/y$b;->a(Landroid/graphics/Bitmap;)Landroid/support/v4/app/y$b;

    move-result-object v1

    .line 369
    invoke-virtual {v1, v3}, Landroid/support/v4/app/y$b;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/y$b;

    move-result-object v1

    .line 370
    invoke-virtual {v1, v4}, Landroid/support/v4/app/y$b;->b(Ljava/lang/CharSequence;)Landroid/support/v4/app/y$b;

    move-result-object v1

    .line 367
    invoke-virtual {v10, v1}, Landroid/support/v4/app/y$d;->a(Landroid/support/v4/app/y$e;)Landroid/support/v4/app/y$d;
    ...
    .line 386
    invoke-virtual {v10, v12}, Landroid/support/v4/app/y$d;->c(I)Landroid/support/v4/app/y$d;

    .line 388
    :cond_7
    invoke-virtual {v10, v9}, Landroid/support/v4/app/y$d;->a(Z)Landroid/support/v4/app/y$d;

    .line 389
    invoke-virtual {v10, v2}, Landroid/support/v4/app/y$d;->a(Landroid/app/PendingIntent;)Landroid/support/v4/app/y$d;
    ...
    invoke-interface {v0, v10, p1}, Lcom/leanplum/LeanplumPushNotificationCustomizer;->customize(Landroid/support/v4/app/y$d;Landroid/os/Bundle;)V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_1
    ...
    invoke-direct {v2, v1, v7, v0, v10}, Lcom/leanplum/LeanplumPushService$2;-><init>(Landroid/app/Notification$Builder;Landroid/app/NotificationManager;ILandroid/support/v4/app/y$d;)V
    ...
    .line 351
    :cond_9
    invoke-virtual {v10, v6}, Landroid/support/v4/app/y$d;->a(I)Landroid/support/v4/app/y$d;
    ...
    :cond_10
    :try_start_4
    invoke-virtual {v10}, Landroid/support/v4/app/y$d;->a()Landroid/app/Notification;
