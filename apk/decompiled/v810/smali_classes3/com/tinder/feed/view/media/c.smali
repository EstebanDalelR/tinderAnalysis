.class public final Lcom/tinder/feed/view/media/c;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/tinder/feed/view/media/c$a;
    }
.end annotation
...
.method static constructor <clinit>()V
    ...
    const-class v3, Lcom/tinder/feed/view/media/c;
    ...
    sput-object v1, Lcom/tinder/feed/view/media/c;->a:[Lkotlin/reflect/k;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    new-instance v0, Lcom/tinder/feed/view/media/FeedNewMatchMediaView$$special$$inlined$bindView$1;

    invoke-direct {v0, p0, v1}, Lcom/tinder/feed/view/media/FeedNewMatchMediaView$$special$$inlined$bindView$1;-><init>(Landroid/view/View;I)V
    ...
    iput-object v0, p0, Lcom/tinder/feed/view/media/c;->b:Lkotlin/d;
    ...
    new-instance v0, Lcom/tinder/feed/view/media/FeedNewMatchMediaView$$special$$inlined$bindView$2;

    invoke-direct {v0, p0, v1}, Lcom/tinder/feed/view/media/FeedNewMatchMediaView$$special$$inlined$bindView$2;-><init>(Landroid/view/View;I)V
    ...
    iput-object v0, p0, Lcom/tinder/feed/view/media/c;->c:Lkotlin/d;
    ...
    invoke-virtual {p0, v0}, Lcom/tinder/feed/view/media/c;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V
...
.method public synthetic constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;ILkotlin/jvm/internal/f;)V
    ...
    :goto_0
    invoke-direct {p0, p1, v0}, Lcom/tinder/feed/view/media/c;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method private final getMediaViewPager()Lcom/tinder/feed/view/FeedCarouselView;
    ...
    iget-object v0, p0, Lcom/tinder/feed/view/media/c;->b:Lkotlin/d;

    sget-object v1, Lcom/tinder/feed/view/media/c;->a:[Lkotlin/reflect/k;
...
.method private final getTitleIndicator()Lcom/viewpagerindicator/CirclePageIndicator;
    ...
    iget-object v0, p0, Lcom/tinder/feed/view/media/c;->c:Lkotlin/d;
...
# virtual methods
.method public final a(Lcom/tinder/feed/view/model/l;Lcom/tinder/feed/view/media/i;)V
    .locals 4
    ...
    .line 40
    invoke-direct {p0}, Lcom/tinder/feed/view/media/c;->getMediaViewPager()Lcom/tinder/feed/view/FeedCarouselView;

    move-result-object v2

    .line 41
    new-instance v0, Lcom/tinder/feed/view/media/c$a;

    invoke-direct {v0, p1, p2}, Lcom/tinder/feed/view/media/c$a;-><init>(Lcom/tinder/feed/view/model/l;Lcom/tinder/feed/view/media/i;)V

    check-cast v0, Landroid/support/v4/view/p;

    .line 42
    invoke-static {p1}, Lcom/tinder/feed/view/b/a;->a(Lcom/tinder/feed/view/model/l;)Lcom/tinder/feed/view/FeedCarouselView$a;
    ...
    .line 44
    invoke-direct {p0}, Lcom/tinder/feed/view/media/c;->getTitleIndicator()Lcom/viewpagerindicator/CirclePageIndicator;
