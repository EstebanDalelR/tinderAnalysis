...
.method private final a(Landroid/view/View;)V
    ...
    :cond_0
    check-cast p1, Lcom/tinder/paywall/views/g;

    .line 95
    invoke-interface {p1}, Lcom/tinder/paywall/views/g;->isActivated()Z
    ...
    :cond_3
    check-cast v0, Lcom/tinder/paywall/views/g;

    .line 102
    invoke-interface {p1}, Lcom/tinder/paywall/views/g;->getPosition()I
    ...
    invoke-interface {p1, v0}, Lcom/tinder/paywall/views/g;->setItemEnabled(Z)V
    ...
    .line 106
    :cond_4
    invoke-interface {v0}, Lcom/tinder/paywall/views/g;->a()V
...
.method public final setViewModel(Lcom/tinder/paywall/viewmodels/h;)V
    ...
    .line 57
    :cond_1
    invoke-virtual {p0}, Lcom/tinder/paywall/views/PaywallItemGroupView;->removeAllViews()V
    ...
    .line 62
    sget-object v0, Lcom/tinder/paywall/views/f;->a:[I
    ...
    invoke-interface {v2, v1}, Lcom/tinder/paywall/views/g;->a(Lcom/tinder/paywall/viewmodels/l;)V
    ...
    .line 74
    invoke-interface {v2, v4}, Lcom/tinder/paywall/views/g;->setItemEnabled(Z)V
    ...
    invoke-interface {v2, v0}, Lcom/tinder/paywall/views/g;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    .line 79
    invoke-interface {v2, v3}, Lcom/tinder/paywall/views/g;->setPosition(I)V
    ...
    .line 65
    :pswitch_2
    new-instance v0, Lcom/tinder/paywall/views/c;
    ...
    invoke-direct {v0, v1, v8, v2, v8}, Lcom/tinder/paywall/views/c;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;ILkotlin/jvm/internal/f;)V
