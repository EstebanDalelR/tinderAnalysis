...
# direct methods
.method public constructor <init>(Lio/reactivex/t;Ljava/lang/Iterable;Lio/reactivex/b/h;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableWithLatestFromMany;->b:[Lio/reactivex/t;

    .line 57
    iput-object p2, p0, Lio/reactivex/internal/operators/observable/ObservableWithLatestFromMany;->c:Ljava/lang/Iterable;

    .line 58
    iput-object p3, p0, Lio/reactivex/internal/operators/observable/ObservableWithLatestFromMany;->d:Lio/reactivex/b/h;

    .line 59
    return-void
.end method

.method public constructor <init>(Lio/reactivex/t;[Lio/reactivex/t;Lio/reactivex/b/h;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 49
    iput-object p2, p0, Lio/reactivex/internal/operators/observable/ObservableWithLatestFromMany;->b:[Lio/reactivex/t;
...
.method protected subscribeActual(Lio/reactivex/v;)V
    ...
    .prologue
    .line 63
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableWithLatestFromMany;->b:[Lio/reactivex/t;
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableWithLatestFromMany;->a:Lio/reactivex/t;
    ...
    invoke-direct {v0, v1, v2}, Lio/reactivex/internal/operators/observable/ay;-><init>(Lio/reactivex/t;Lio/reactivex/b/h;)V

    invoke-virtual {v0, p1}, Lio/reactivex/internal/operators/observable/ay;->subscribeActual(Lio/reactivex/v;)V
    ...
    iget-object v3, p0, Lio/reactivex/internal/operators/observable/ObservableWithLatestFromMany;->d:Lio/reactivex/b/h;

    invoke-direct {v2, p1, v3, v0}, Lio/reactivex/internal/operators/observable/ObservableWithLatestFromMany$WithLatestFromObserver;-><init>(Lio/reactivex/v;Lio/reactivex/b/h;I)V

    .line 91
    invoke-interface {p1, v2}, Lio/reactivex/v;->onSubscribe(Lio/reactivex/disposables/b;)V

    .line 92
    invoke-virtual {v2, v1, v0}, Lio/reactivex/internal/operators/observable/ObservableWithLatestFromMany$WithLatestFromObserver;->a([Lio/reactivex/t;I)V

    .line 94
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableWithLatestFromMany;->a:Lio/reactivex/t;
