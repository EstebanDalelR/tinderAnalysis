...
.method constructor <init>(Lio/reactivex/v;Lio/reactivex/b/h;IZ)V
    ...
    .line 90
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableZip$ZipCoordinator;->a:Lio/reactivex/v;

    .line 91
    iput-object p2, p0, Lio/reactivex/internal/operators/observable/ObservableZip$ZipCoordinator;->b:Lio/reactivex/b/h;
...
.method public a([Lio/reactivex/t;I)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([",
    ...
    .line 105
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableZip$ZipCoordinator;->a:Lio/reactivex/v;
...
.method a(ZZLio/reactivex/v;ZLio/reactivex/internal/operators/observable/ObservableZip$a;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZ",
...
.method public d()V
    ...
    .line 155
    iget-object v3, p0, Lio/reactivex/internal/operators/observable/ObservableZip$ZipCoordinator;->a:Lio/reactivex/v;
    ...
    .line 170
    invoke-virtual/range {v0 .. v5}, Lio/reactivex/internal/operators/observable/ObservableZip$ZipCoordinator;->a(ZZLio/reactivex/v;ZLio/reactivex/internal/operators/observable/ObservableZip$a;)Z
    ...
    .line 183
    invoke-interface {v3, v0}, Lio/reactivex/v;->onError(Ljava/lang/Throwable;)V
    ...
    :cond_7
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableZip$ZipCoordinator;->b:Lio/reactivex/b/h;
    ...
    .line 205
    invoke-interface {v3, v0}, Lio/reactivex/v;->onNext(Ljava/lang/Object;)V
