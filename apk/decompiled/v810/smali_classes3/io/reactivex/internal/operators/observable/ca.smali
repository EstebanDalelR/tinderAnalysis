...
# direct methods
.method public constructor <init>(Lio/reactivex/t;JJLjava/util/concurrent/TimeUnit;Lio/reactivex/w;JIZ)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 49
    iput-object p7, p0, Lio/reactivex/internal/operators/observable/ca;->e:Lio/reactivex/w;
...
.method public subscribeActual(Lio/reactivex/v;)V
    ...
    .line 61
    iget-object v7, p0, Lio/reactivex/internal/operators/observable/ca;->a:Lio/reactivex/t;
    ...
    iget-object v5, p0, Lio/reactivex/internal/operators/observable/ca;->e:Lio/reactivex/w;

    iget v6, p0, Lio/reactivex/internal/operators/observable/ca;->g:I

    invoke-direct/range {v0 .. v6}, Lio/reactivex/internal/operators/observable/ca$b;-><init>(Lio/reactivex/v;JLjava/util/concurrent/TimeUnit;Lio/reactivex/w;I)V
    ...
    .line 66
    :cond_0
    iget-object v10, p0, Lio/reactivex/internal/operators/observable/ca;->a:Lio/reactivex/t;
    ...
    invoke-direct/range {v0 .. v9}, Lio/reactivex/internal/operators/observable/ca$a;-><init>(Lio/reactivex/v;JLjava/util/concurrent/TimeUnit;Lio/reactivex/w;IJZ)V

    invoke-interface {v10, v0}, Lio/reactivex/t;->subscribe(Lio/reactivex/v;)V

    goto :goto_0

    .line 72
    :cond_1
    iget-object v9, p0, Lio/reactivex/internal/operators/observable/ca;->a:Lio/reactivex/t;
    ...
    iget-object v7, p0, Lio/reactivex/internal/operators/observable/ca;->e:Lio/reactivex/w;

    .line 73
    invoke-virtual {v7}, Lio/reactivex/w;->a()Lio/reactivex/w$c;

    move-result-object v7

    iget v8, p0, Lio/reactivex/internal/operators/observable/ca;->g:I

    invoke-direct/range {v0 .. v8}, Lio/reactivex/internal/operators/observable/ca$c;-><init>(Lio/reactivex/v;JJLjava/util/concurrent/TimeUnit;Lio/reactivex/w$c;I)V

    .line 72
    invoke-interface {v9, v0}, Lio/reactivex/t;->subscribe(Lio/reactivex/v;)V
