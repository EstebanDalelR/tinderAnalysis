...
# direct methods
.method public constructor <init>(Lio/reactivex/t;JJLjava/util/concurrent/TimeUnit;Lio/reactivex/w;Ljava/util/concurrent/Callable;IZ)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 49
    iput-object p7, p0, Lio/reactivex/internal/operators/observable/m;->e:Lio/reactivex/w;
...
.method protected subscribeActual(Lio/reactivex/v;)V
    ...
    .line 58
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/m;->a:Lio/reactivex/t;
    ...
    iget-object v7, p0, Lio/reactivex/internal/operators/observable/m;->e:Lio/reactivex/w;

    invoke-direct/range {v1 .. v7}, Lio/reactivex/internal/operators/observable/m$b;-><init>(Lio/reactivex/v;Ljava/util/concurrent/Callable;JLjava/util/concurrent/TimeUnit;Lio/reactivex/w;)V
    ...
    .line 63
    :cond_0
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/m;->e:Lio/reactivex/w;
    ...
    invoke-direct/range {v1 .. v9}, Lio/reactivex/internal/operators/observable/m$a;-><init>(Lio/reactivex/v;Ljava/util/concurrent/Callable;JLjava/util/concurrent/TimeUnit;IZLio/reactivex/w$c;)V
    ...
    invoke-direct/range {v1 .. v9}, Lio/reactivex/internal/operators/observable/m$c;-><init>(Lio/reactivex/v;Ljava/util/concurrent/Callable;JJLjava/util/concurrent/TimeUnit;Lio/reactivex/w$c;)V
