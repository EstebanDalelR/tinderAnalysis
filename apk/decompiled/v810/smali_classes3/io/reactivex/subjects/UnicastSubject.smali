...
.method a(Lio/reactivex/v;)V
    ...
    .line 280
    invoke-interface {v6}, Lio/reactivex/internal/a/i;->c()V
    ...
    .line 290
    invoke-virtual {p0, v6, p1}, Lio/reactivex/subjects/UnicastSubject;->a(Lio/reactivex/internal/a/i;Lio/reactivex/v;)Z
    ...
    .line 298
    invoke-virtual {p0, p1}, Lio/reactivex/subjects/UnicastSubject;->c(Lio/reactivex/v;)V
    ...
    .line 307
    :cond_7
    invoke-interface {p1, v8}, Lio/reactivex/v;->onNext(Ljava/lang/Object;)V

    goto :goto_1
.end method

.method a(Lio/reactivex/internal/a/i;Lio/reactivex/v;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 366
    invoke-interface {p1}, Lio/reactivex/internal/a/i;->c()V

    .line 367
    invoke-interface {p2, v0}, Lio/reactivex/v;->onError(Ljava/lang/Throwable;)V
...
.method b(Lio/reactivex/v;)V
    ...
    .line 333
    invoke-virtual {p0, v2, p1}, Lio/reactivex/subjects/UnicastSubject;->a(Lio/reactivex/internal/a/i;Lio/reactivex/v;)Z
    ...
    .line 338
    :cond_4
    invoke-interface {p1, v5}, Lio/reactivex/v;->onNext(Ljava/lang/Object;)V
...
.method c()V
    ...
    .line 386
    invoke-virtual {p0, v1}, Lio/reactivex/subjects/UnicastSubject;->b(Lio/reactivex/v;)V

    goto :goto_0

    .line 388
    :cond_2
    invoke-virtual {p0, v1}, Lio/reactivex/subjects/UnicastSubject;->a(Lio/reactivex/v;)V
