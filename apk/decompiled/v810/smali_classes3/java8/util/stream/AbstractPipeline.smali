...
.method constructor <init>(Ljava8/util/Spliterator;IZ)V
    ...
    sget v1, Ljava8/util/stream/StreamOpFlag;->k:I
...
.method constructor <init>(Ljava8/util/stream/AbstractPipeline;I)V
    ...
    .line 209
    sget v0, Ljava8/util/stream/StreamOpFlag;->h:I
    ...
    invoke-static {p2, v0}, Ljava8/util/stream/StreamOpFlag;->a(II)I
...
.method private b(I)Ljava8/util/Spliterator;
    ...
    .line 422
    sget-object v5, Ljava8/util/stream/StreamOpFlag;->e:Ljava8/util/stream/StreamOpFlag;

    invoke-virtual {v5, v0}, Ljava8/util/stream/StreamOpFlag;->a(I)Z
    ...
    .line 428
    sget v5, Ljava8/util/stream/StreamOpFlag;->t:I
    ...
    sget v5, Ljava8/util/stream/StreamOpFlag;->s:I

    xor-int/lit8 v5, v5, -0x1

    and-int/2addr v0, v5

    sget v5, Ljava8/util/stream/StreamOpFlag;->r:I
    ...
    invoke-static {v0, v1}, Ljava8/util/stream/StreamOpFlag;->a(II)I
    ...
    invoke-static {p1, v1}, Ljava8/util/stream/StreamOpFlag;->a(II)I
...
.method final a(Ljava8/util/stream/TerminalOp;)Ljava/lang/Object;
    ...
    .line 233
    invoke-interface {p1}, Ljava8/util/stream/TerminalOp;->I_()I
...
.method final b(Ljava8/util/stream/Sink;Ljava8/util/Spliterator;)V
    ...
    .line 489
    invoke-interface {p1}, Ljava8/util/stream/Sink;->L_()V
