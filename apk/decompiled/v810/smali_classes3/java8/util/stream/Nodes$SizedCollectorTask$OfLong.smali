...
.method constructor <init>(Ljava8/util/Spliterator;Ljava8/util/stream/PipelineHelper;[J)V
    ...
    .line 2923
    iput-object p3, p0, Ljava8/util/stream/Nodes$SizedCollectorTask$OfLong;->h:[J
...
.method constructor <init>(Ljava8/util/stream/Nodes$SizedCollectorTask$OfLong;Ljava8/util/Spliterator;JJ)V
    ...
    .prologue
    .line 2928
    iget-object v0, p1, Ljava8/util/stream/Nodes$SizedCollectorTask$OfLong;->h:[J
    ...
    iput-object v0, p0, Ljava8/util/stream/Nodes$SizedCollectorTask$OfLong;->h:[J
...
.method synthetic a(Ljava8/util/Spliterator;JJ)Ljava8/util/stream/Nodes$SizedCollectorTask;
    ...
    .prologue
    .line 2916
    invoke-virtual/range {p0 .. p5}, Ljava8/util/stream/Nodes$SizedCollectorTask$OfLong;->b(Ljava8/util/Spliterator;JJ)Ljava8/util/stream/Nodes$SizedCollectorTask$OfLong;
...
.method public a(J)V
    ...
    .prologue
    .line 2940
    iget v0, p0, Ljava8/util/stream/Nodes$SizedCollectorTask$OfLong;->f:I

    iget v1, p0, Ljava8/util/stream/Nodes$SizedCollectorTask$OfLong;->g:I
    ...
    iget v1, p0, Ljava8/util/stream/Nodes$SizedCollectorTask$OfLong;->f:I
    ...
    .line 2943
    :cond_0
    iget-object v0, p0, Ljava8/util/stream/Nodes$SizedCollectorTask$OfLong;->h:[J

    iget v1, p0, Ljava8/util/stream/Nodes$SizedCollectorTask$OfLong;->f:I

    add-int/lit8 v2, v1, 0x1

    iput v2, p0, Ljava8/util/stream/Nodes$SizedCollectorTask$OfLong;->f:I
...
.method public synthetic accept(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Ljava8/util/stream/Nodes$SizedCollectorTask$OfLong;->a(Ljava/lang/Long;)V

    return-void
.end method

.method b(Ljava8/util/Spliterator;JJ)Ljava8/util/stream/Nodes$SizedCollectorTask$OfLong;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct/range {v1 .. v7}, Ljava8/util/stream/Nodes$SizedCollectorTask$OfLong;-><init>(Ljava8/util/stream/Nodes$SizedCollectorTask$OfLong;Ljava8/util/Spliterator;JJ)V
