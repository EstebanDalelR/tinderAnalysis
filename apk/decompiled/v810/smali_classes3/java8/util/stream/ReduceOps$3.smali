...
.field final synthetic d:Ljava8/util/stream/Collector;
...
.method constructor <init>(Ljava8/util/stream/StreamShape;Ljava8/util/function/BinaryOperator;Ljava8/util/function/BiConsumer;Ljava8/util/function/Supplier;Ljava8/util/stream/Collector;)V
    ...
    .prologue
    .line 249
    iput-object p2, p0, Ljava8/util/stream/ReduceOps$3;->a:Ljava8/util/function/BinaryOperator;

    iput-object p3, p0, Ljava8/util/stream/ReduceOps$3;->b:Ljava8/util/function/BiConsumer;

    iput-object p4, p0, Ljava8/util/stream/ReduceOps$3;->c:Ljava8/util/function/Supplier;

    iput-object p5, p0, Ljava8/util/stream/ReduceOps$3;->d:Ljava8/util/stream/Collector;
...
.method public I_()I
    ...
    .prologue
    .line 257
    iget-object v0, p0, Ljava8/util/stream/ReduceOps$3;->d:Ljava8/util/stream/Collector;

    invoke-interface {v0}, Ljava8/util/stream/Collector;->e()Ljava/util/Set;
...
.method public b()Ljava8/util/stream/ReduceOps$3ReducingSink;
    .locals 4
    ...
    iget-object v1, p0, Ljava8/util/stream/ReduceOps$3;->c:Ljava8/util/function/Supplier;

    iget-object v2, p0, Ljava8/util/stream/ReduceOps$3;->b:Ljava8/util/function/BiConsumer;

    iget-object v3, p0, Ljava8/util/stream/ReduceOps$3;->a:Ljava8/util/function/BinaryOperator;
...
.method public synthetic c()Ljava8/util/stream/ReduceOps$AccumulatingSink;
    ...
    .prologue
    .line 249
    invoke-virtual {p0}, Ljava8/util/stream/ReduceOps$3;->b()Ljava8/util/stream/ReduceOps$3ReducingSink;
