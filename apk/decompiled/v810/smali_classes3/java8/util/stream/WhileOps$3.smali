...
.method static synthetic c(I)[Ljava/lang/Long;
    ...
    invoke-static {p0}, Ljava8/util/stream/WhileOps$3;->d(I)[Ljava/lang/Long;
...
.method a(Ljava8/util/stream/PipelineHelper;Ljava8/util/Spliterator;)Ljava8/util/Spliterator;
    ...
    .line 185
    invoke-static {}, Ljava8/util/stream/WhileOps$3$$Lambda$1;->a()Ljava8/util/function/IntFunction;

    move-result-object v0

    invoke-virtual {p0, p1, p2, v0}, Ljava8/util/stream/WhileOps$3;->a(Ljava8/util/stream/PipelineHelper;Ljava8/util/Spliterator;Ljava8/util/function/IntFunction;)Ljava8/util/stream/Node;
    ...
    .line 189
    :cond_0
    new-instance v1, Ljava8/util/stream/WhileOps$UnorderedWhileSpliterator$OfLong$Taking;
    ...
    iget-object v3, p0, Ljava8/util/stream/WhileOps$3;->b:Ljava8/util/function/LongPredicate;

    invoke-direct {v1, v0, v2, v3}, Ljava8/util/stream/WhileOps$UnorderedWhileSpliterator$OfLong$Taking;-><init>(Ljava8/util/Spliterator$OfLong;ZLjava8/util/function/LongPredicate;)V
...
.method a(ILjava8/util/stream/Sink;)Ljava8/util/stream/Sink;
    ...
    .prologue
    .line 204
    new-instance v0, Ljava8/util/stream/WhileOps$3$1;

    invoke-direct {v0, p0, p2}, Ljava8/util/stream/WhileOps$3$1;-><init>(Ljava8/util/stream/WhileOps$3;Ljava8/util/stream/Sink;)V
