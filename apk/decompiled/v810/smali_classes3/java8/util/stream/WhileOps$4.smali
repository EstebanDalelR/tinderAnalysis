...
.method static synthetic c(I)[Ljava/lang/Double;
    ...
    invoke-static {p0}, Ljava8/util/stream/WhileOps$4;->d(I)[Ljava/lang/Double;
...
.method a(Ljava8/util/stream/PipelineHelper;Ljava8/util/Spliterator;)Ljava8/util/Spliterator;
    ...
    .line 242
    invoke-static {}, Ljava8/util/stream/WhileOps$4$$Lambda$1;->a()Ljava8/util/function/IntFunction;

    move-result-object v0

    invoke-virtual {p0, p1, p2, v0}, Ljava8/util/stream/WhileOps$4;->a(Ljava8/util/stream/PipelineHelper;Ljava8/util/Spliterator;Ljava8/util/function/IntFunction;)Ljava8/util/stream/Node;
    ...
    .line 246
    :cond_0
    new-instance v1, Ljava8/util/stream/WhileOps$UnorderedWhileSpliterator$OfDouble$Taking;
    ...
    iget-object v3, p0, Ljava8/util/stream/WhileOps$4;->b:Ljava8/util/function/DoublePredicate;

    invoke-direct {v1, v0, v2, v3}, Ljava8/util/stream/WhileOps$UnorderedWhileSpliterator$OfDouble$Taking;-><init>(Ljava8/util/Spliterator$OfDouble;ZLjava8/util/function/DoublePredicate;)V
...
.method a(ILjava8/util/stream/Sink;)Ljava8/util/stream/Sink;
    ...
    .prologue
    .line 261
    new-instance v0, Ljava8/util/stream/WhileOps$4$1;

    invoke-direct {v0, p0, p2}, Ljava8/util/stream/WhileOps$4$1;-><init>(Ljava8/util/stream/WhileOps$4;Ljava8/util/stream/Sink;)V
