...
.method public static a(Lokhttp3/internal/d/a;Ljava/io/File;IIJ)Lokhttp3/internal/a/d;
    ...
    invoke-direct/range {v3 .. v10}, Lokhttp3/internal/a/d;-><init>(Lokhttp3/internal/d/a;Ljava/io/File;IIJLjava/util/concurrent/Executor;)V
...
.method private h()V
    ...
    invoke-interface {v0, v1}, Lokhttp3/internal/d/a;->a(Ljava/io/File;)Lokio/t;
    ...
    :cond_2
    :try_start_3
    invoke-direct {p0}, Lokhttp3/internal/a/d;->i()Lokio/d;
...
.method private i()Lokio/d;
    ...
    invoke-interface {v0, v1}, Lokhttp3/internal/d/a;->c(Ljava/io/File;)Lokio/s;
    ...
    invoke-direct {v1, p0, v0}, Lokhttp3/internal/a/d$2;-><init>(Lokhttp3/internal/a/d;Lokio/s;)V

    .line 322
    invoke-static {v1}, Lokio/m;->a(Lokio/s;)Lokio/d;
...
.method declared-synchronized a(Ljava/lang/String;J)Lokhttp3/internal/a/d$a;
    ...
    .line 486
    :cond_4
    iget-object v2, p0, Lokhttp3/internal/a/d;->e:Lokio/d;
    ...
    invoke-interface {v2, v3}, Lokio/d;->k(I)Lokio/d;
...
.method public declared-synchronized a(Ljava/lang/String;)Lokhttp3/internal/a/d$c;
    ...
    invoke-interface {v1, v2}, Lokio/d;->k(I)Lokio/d;
...
.method declared-synchronized b()V
    ...
    invoke-interface {v0, v1}, Lokhttp3/internal/d/a;->b(Ljava/io/File;)Lokio/s;
    ...
    invoke-interface {v0, v2}, Lokio/d;->k(I)Lokio/d;
    ...
    invoke-interface {v3, v4}, Lokio/d;->k(I)Lokio/d;
...
.method public declared-synchronized c(Ljava/lang/String;)Z
    ...
    iget-wide v4, p0, Lokhttp3/internal/a/d;->r:J
    ...
    iput-boolean v1, p0, Lokhttp3/internal/a/d;->k:Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
