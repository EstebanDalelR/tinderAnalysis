...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/design/widget/f;->b:Landroid/graphics/Paint;

    .line 51
    sget-object v0, Landroid/support/design/widget/f;->b:Landroid/graphics/Paint;
...
.method public constructor <init>(Landroid/view/View;)V
    ...
    .line 65
    iput v1, p0, Landroid/support/design/widget/f;->i:I

    .line 66
    iput v1, p0, Landroid/support/design/widget/f;->j:I

    .line 67
    iput v0, p0, Landroid/support/design/widget/f;->k:F

    .line 68
    iput v0, p0, Landroid/support/design/widget/f;->l:F

    .line 111
    iput-object p1, p0, Landroid/support/design/widget/f;->c:Landroid/view/View;
    ...
    iput-object v0, p0, Landroid/support/design/widget/f;->J:Landroid/text/TextPaint;
    ...
    iput-object v0, p0, Landroid/support/design/widget/f;->f:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Landroid/support/design/widget/f;->h:Landroid/graphics/RectF;
...
.method private b(Ljava/lang/CharSequence;)Z
    ...
    .line 524
    iget-object v2, p0, Landroid/support/design/widget/f;->c:Landroid/view/View;
...
.method private c(F)V
    ...
    iget-object v2, p0, Landroid/support/design/widget/f;->K:Landroid/view/animation/Interpolator;
    ...
    invoke-direct {p0, v0}, Landroid/support/design/widget/f;->e(F)V

    .line 358
    iget-object v0, p0, Landroid/support/design/widget/f;->n:Landroid/content/res/ColorStateList;

    iget-object v1, p0, Landroid/support/design/widget/f;->m:Landroid/content/res/ColorStateList;

    if-eq v0, v1, :cond_0

    .line 361
    iget-object v0, p0, Landroid/support/design/widget/f;->J:Landroid/text/TextPaint;

    .line 362
    invoke-direct {p0}, Landroid/support/design/widget/f;->m()I

    move-result v1

    invoke-direct {p0}, Landroid/support/design/widget/f;->n()I
    ...
    .line 373
    iget-object v0, p0, Landroid/support/design/widget/f;->c:Landroid/view/View;
...
.method private d(F)V
    ...
    .prologue
    .line 469
    iget-object v0, p0, Landroid/support/design/widget/f;->h:Landroid/graphics/RectF;

    iget-object v1, p0, Landroid/support/design/widget/f;->f:Landroid/graphics/Rect;
    ...
    iget-object v3, p0, Landroid/support/design/widget/f;->K:Landroid/view/animation/Interpolator;
    ...
    iget v1, p0, Landroid/support/design/widget/f;->o:F

    iget v2, p0, Landroid/support/design/widget/f;->p:F
...
.method private e(F)V
    ...
    .prologue
    .line 532
    invoke-direct {p0, p1}, Landroid/support/design/widget/f;->f(F)V
    ...
    .line 537
    iget-boolean v0, p0, Landroid/support/design/widget/f;->A:Z
...
.method private f(F)V
    ...
    .line 550
    iget-object v0, p0, Landroid/support/design/widget/f;->x:Ljava/lang/CharSequence;
    ...
    .line 553
    iget-object v0, p0, Landroid/support/design/widget/f;->f:Landroid/graphics/Rect;
    ...
    .line 561
    iput v8, p0, Landroid/support/design/widget/f;->F:F

    .line 562
    iget-object v0, p0, Landroid/support/design/widget/f;->w:Landroid/graphics/Typeface;

    iget-object v5, p0, Landroid/support/design/widget/f;->u:Landroid/graphics/Typeface;

    invoke-direct {p0, v0, v5}, Landroid/support/design/widget/f;->a(Landroid/graphics/Typeface;Landroid/graphics/Typeface;)Z
    ...
    .line 563
    iget-object v0, p0, Landroid/support/design/widget/f;->u:Landroid/graphics/Typeface;
    ...
    .line 598
    iget v5, p0, Landroid/support/design/widget/f;->G:F

    cmpl-float v5, v5, v3

    if-nez v5, :cond_2

    iget-boolean v5, p0, Landroid/support/design/widget/f;->I:Z
    ...
    .line 599
    :goto_2
    iput v3, p0, Landroid/support/design/widget/f;->G:F

    .line 600
    iput-boolean v2, p0, Landroid/support/design/widget/f;->I:Z

    .line 603
    :cond_3
    iget-object v3, p0, Landroid/support/design/widget/f;->y:Ljava/lang/CharSequence;
    ...
    iget-object v3, p0, Landroid/support/design/widget/f;->w:Landroid/graphics/Typeface;
    ...
    iget-object v1, p0, Landroid/support/design/widget/f;->J:Landroid/text/TextPaint;
    ...
    .line 612
    iget-object v1, p0, Landroid/support/design/widget/f;->y:Ljava/lang/CharSequence;
    ...
    .line 613
    iput-object v0, p0, Landroid/support/design/widget/f;->y:Ljava/lang/CharSequence;
    ...
    iput-boolean v0, p0, Landroid/support/design/widget/f;->z:Z

    goto :goto_0

    .line 568
    :cond_5
    iget v3, p0, Landroid/support/design/widget/f;->k:F

    .line 569
    iget-object v0, p0, Landroid/support/design/widget/f;->w:Landroid/graphics/Typeface;

    iget-object v6, p0, Landroid/support/design/widget/f;->v:Landroid/graphics/Typeface;

    invoke-direct {p0, v0, v6}, Landroid/support/design/widget/f;->a(Landroid/graphics/Typeface;Landroid/graphics/Typeface;)Z
    ...
    .line 573
    :goto_4
    iget v6, p0, Landroid/support/design/widget/f;->k:F
    ...
    iget v7, p0, Landroid/support/design/widget/f;->k:F
    ...
    iput v6, p0, Landroid/support/design/widget/f;->F:F
...
.method private m()I
    ...
    .prologue
    .line 378
    iget-object v0, p0, Landroid/support/design/widget/f;->H:[I

    if-eqz v0, :cond_0

    .line 379
    iget-object v0, p0, Landroid/support/design/widget/f;->m:Landroid/content/res/ColorStateList;

    iget-object v1, p0, Landroid/support/design/widget/f;->H:[I
...
.method private o()V
    ...
    iget-object v2, p0, Landroid/support/design/widget/f;->y:Ljava/lang/CharSequence;

    iget-object v6, p0, Landroid/support/design/widget/f;->y:Ljava/lang/CharSequence;
    ...
    .line 401
    :goto_0
    iget v6, p0, Landroid/support/design/widget/f;->j:I

    iget-boolean v2, p0, Landroid/support/design/widget/f;->z:Z
    ...
    :goto_1
    invoke-static {v6, v2}, Landroid/support/v4/view/d;->a(II)I
    ...
    .line 412
    iget-object v6, p0, Landroid/support/design/widget/f;->J:Landroid/text/TextPaint;

    invoke-virtual {v6}, Landroid/text/TextPaint;->descent()F

    move-result v6

    iget-object v7, p0, Landroid/support/design/widget/f;->J:Landroid/text/TextPaint;
    ...
    .line 414
    iget-object v7, p0, Landroid/support/design/widget/f;->g:Landroid/graphics/Rect;
    ...
    iput v6, p0, Landroid/support/design/widget/f;->p:F
    ...
    .line 433
    :cond_0
    iget v0, p0, Landroid/support/design/widget/f;->i:I
    ...
    :goto_4
    invoke-static {v0, v3}, Landroid/support/v4/view/d;->a(II)I
    ...
    .line 444
    iget-object v2, p0, Landroid/support/design/widget/f;->J:Landroid/text/TextPaint;

    invoke-virtual {v2}, Landroid/text/TextPaint;->descent()F

    move-result v2

    iget-object v3, p0, Landroid/support/design/widget/f;->J:Landroid/text/TextPaint;
    ...
    .line 446
    iget-object v3, p0, Landroid/support/design/widget/f;->f:Landroid/graphics/Rect;
    ...
    iput v2, p0, Landroid/support/design/widget/f;->o:F
    ...
    .line 465
    invoke-direct {p0, v5}, Landroid/support/design/widget/f;->e(F)V
    ...
    .line 405
    :sswitch_0
    iget-object v6, p0, Landroid/support/design/widget/f;->g:Landroid/graphics/Rect;
    ...
    .line 437
    :sswitch_4
    iget-object v2, p0, Landroid/support/design/widget/f;->f:Landroid/graphics/Rect;
...
.method private p()V
    ...
    .line 620
    iget-object v0, p0, Landroid/support/design/widget/f;->B:Landroid/graphics/Bitmap;
    ...
    .line 625
    :cond_1
    invoke-direct {p0, v4}, Landroid/support/design/widget/f;->c(F)V
    ...
    iput-object v0, p0, Landroid/support/design/widget/f;->B:Landroid/graphics/Bitmap;

    .line 638
    new-instance v0, Landroid/graphics/Canvas;

    iget-object v1, p0, Landroid/support/design/widget/f;->B:Landroid/graphics/Bitmap;
    ...
    .line 641
    iget-object v0, p0, Landroid/support/design/widget/f;->C:Landroid/graphics/Paint;
    ...
    iput-object v0, p0, Landroid/support/design/widget/f;->C:Landroid/graphics/Paint;
...
.method a()V
    ...
    :goto_0
    iput-boolean v0, p0, Landroid/support/design/widget/f;->d:Z
...
.method a(F)V
    ...
    .line 133
    invoke-virtual {p0}, Landroid/support/design/widget/f;->i()V
...
.method a(I)V
    ...
    .line 181
    iput p1, p0, Landroid/support/design/widget/f;->i:I
...
.method a(IIII)V
    ...
    iput-boolean v0, p0, Landroid/support/design/widget/f;->I:Z
...
.method public a(Landroid/graphics/Canvas;)V
    ...
    iget-boolean v0, p0, Landroid/support/design/widget/f;->d:Z

    if-eqz v0, :cond_2

    .line 483
    iget v4, p0, Landroid/support/design/widget/f;->s:F

    .line 484
    iget v5, p0, Landroid/support/design/widget/f;->t:F
    ...
    iget v6, p0, Landroid/support/design/widget/f;->F:F
    ...
    iget-object v1, p0, Landroid/support/design/widget/f;->C:Landroid/graphics/Paint;
...
.method a(Landroid/graphics/Typeface;)V
    ...
    invoke-direct {p0, v0, p1}, Landroid/support/design/widget/f;->a(Landroid/graphics/Typeface;Landroid/graphics/Typeface;)Z
    ...
    .line 275
    iput-object p1, p0, Landroid/support/design/widget/f;->u:Landroid/graphics/Typeface;
...
.method a(Ljava/lang/CharSequence;)V
    ...
    .line 663
    :cond_0
    iput-object p1, p0, Landroid/support/design/widget/f;->x:Ljava/lang/CharSequence;
...
.method final a([I)Z
    ...
    .prologue
    .line 317
    iput-object p1, p0, Landroid/support/design/widget/f;->H:[I
...
.method b(Landroid/content/res/ColorStateList;)V
    ...
    .line 153
    iput-object p1, p0, Landroid/support/design/widget/f;->m:Landroid/content/res/ColorStateList;
...
.method b(Landroid/view/animation/Interpolator;)V
    ...
    .prologue
    .line 126
    iput-object p1, p0, Landroid/support/design/widget/f;->K:Landroid/view/animation/Interpolator;
...
.method c(I)V
    ...
    iput-object v0, p0, Landroid/support/design/widget/f;->u:Landroid/graphics/Typeface;
...
.method d(I)V
    ...
    iput-object v1, p0, Landroid/support/design/widget/f;->m:Landroid/content/res/ColorStateList;
    ...
    iget v2, p0, Landroid/support/design/widget/f;->k:F
    ...
    iput v1, p0, Landroid/support/design/widget/f;->k:F
