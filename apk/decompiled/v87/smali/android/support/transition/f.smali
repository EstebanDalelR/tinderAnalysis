...
.method public constructor <init>()V
    ...
    .line 163
    iput-boolean v1, p0, Landroid/support/transition/f;->o:Z

    .line 164
    iput-boolean v1, p0, Landroid/support/transition/f;->p:Z
...
.method private a(Landroid/view/View;Landroid/view/View;)Z
    ...
    .line 244
    .line 245
    iget-boolean v2, p0, Landroid/support/transition/f;->p:Z

    if-eqz v2, :cond_0

    .line 246
    invoke-virtual {p0, p1, v0}, Landroid/support/transition/f;->b(Landroid/view/View;Z)Landroid/support/transition/ac;
    ...
    .line 250
    :cond_2
    iget-object v2, v2, Landroid/support/transition/ac;->b:Landroid/view/View;
...
.method private d(Landroid/support/transition/ac;)V
    ...
    iget-object v3, p1, Landroid/support/transition/ac;->b:Landroid/view/View;
    ...
    invoke-static {v0}, Landroid/support/v4/view/s;->B(Landroid/view/View;)Landroid/graphics/Rect;
...
.method public a(Landroid/view/ViewGroup;Landroid/support/transition/ac;Landroid/support/transition/ac;)Landroid/animation/Animator;
    ...
    iget-object v1, v0, Landroid/support/transition/ac;->a:Ljava/util/Map;

    .line 264
    move-object/from16 v0, p3

    iget-object v2, v0, Landroid/support/transition/ac;->a:Ljava/util/Map;
    ...
    invoke-direct {v0, v1, v2}, Landroid/support/transition/f;->a(Landroid/view/View;Landroid/view/View;)Z
    ...
    iget-boolean v0, v0, Landroid/support/transition/f;->o:Z
    ...
    .line 300
    invoke-static {v3, v9, v10, v11, v12}, Landroid/support/transition/ap;->a(Landroid/view/View;IIII)V
    ...
    .line 306
    sget-object v2, Landroid/support/transition/f;->m:Landroid/util/Property;
    ...
    invoke-static {v1, v3}, Landroid/support/transition/ai;->a(Landroid/view/ViewGroup;Z)V
    ...
    invoke-virtual {v0, v3}, Landroid/support/transition/f;->a(Landroid/support/transition/w$c;)Landroid/support/transition/w;
    ...
    invoke-virtual {v1, v4, v9, v5, v6}, Landroid/support/transition/l;->a(FFFF)Landroid/graphics/Path;
    ...
    .line 317
    sget-object v5, Landroid/support/transition/f;->j:Landroid/util/Property;
    ...
    .line 337
    sget-object v2, Landroid/support/transition/f;->k:Landroid/util/Property;
    ...
    invoke-static {v3, v9, v10, v2, v11}, Landroid/support/transition/ap;->a(Landroid/view/View;IIII)V
    ...
    .line 351
    sget-object v9, Landroid/support/transition/f;->m:Landroid/util/Property;
    ...
    .line 363
    invoke-static {v3, v9}, Landroid/support/v4/view/s;->a(Landroid/view/View;Landroid/graphics/Rect;)V

    .line 364
    const-string v2, "clipBounds"

    sget-object v11, Landroid/support/transition/f;->q:Landroid/support/transition/s;
    ...
    .line 384
    :goto_5
    invoke-static {v10, v1}, Landroid/support/transition/ab;->a(Landroid/animation/Animator;Landroid/animation/Animator;)Landroid/animation/Animator;
    ...
    iget-object v6, v0, Landroid/support/transition/f;->n:[I
    ...
    .line 435
    invoke-static {v3}, Landroid/support/transition/ap;->c(Landroid/view/View;)F
    ...
    invoke-static {v3, v6}, Landroid/support/transition/ap;->a(Landroid/view/View;F)V

    .line 437
    invoke-static/range {p1 .. p1}, Landroid/support/transition/ap;->a(Landroid/view/View;)Landroid/support/transition/ao;

    move-result-object v6

    invoke-interface {v6, v7}, Landroid/support/transition/ao;->a(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v8, v0, Landroid/support/transition/f;->n:[I
    ...
    .line 441
    sget-object v2, Landroid/support/transition/f;->h:Landroid/util/Property;
...
.method public a(Landroid/support/transition/ac;)V
    ...
    .prologue
    .line 235
    invoke-direct {p0, p1}, Landroid/support/transition/f;->d(Landroid/support/transition/ac;)V
