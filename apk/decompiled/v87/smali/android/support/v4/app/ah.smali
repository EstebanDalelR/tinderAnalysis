...
# static fields
.field private static final a:Landroid/support/v4/app/ah$c;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/app/ah;->a:Landroid/support/v4/app/ah$c;
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroid/support/v4/app/ah;->b:Ljava/util/ArrayList;

    .line 113
    iput-object p1, p0, Landroid/support/v4/app/ah;->c:Landroid/content/Context;
...
.method public a(Landroid/app/Activity;)Landroid/support/v4/app/ah;
    ...
    .line 190
    instance-of v1, p1, Landroid/support/v4/app/ah$a;
    ...
    invoke-interface {v0}, Landroid/support/v4/app/ah$a;->getSupportParentActivityIntent()Landroid/content/Intent;
    ...
    .line 202
    iget-object v0, p0, Landroid/support/v4/app/ah;->c:Landroid/content/Context;
...
.method public a(Landroid/content/ComponentName;)Landroid/support/v4/app/ah;
    ...
    .prologue
    .line 231
    iget-object v0, p0, Landroid/support/v4/app/ah;->b:Ljava/util/ArrayList;
    ...
    invoke-static {v0, p1}, Landroid/support/v4/app/w;->a(Landroid/content/Context;Landroid/content/ComponentName;)Landroid/content/Intent;
    ...
    .line 235
    iget-object v2, p0, Landroid/support/v4/app/ah;->b:Ljava/util/ArrayList;

    invoke-virtual {v2, v1, v0}, Ljava/util/ArrayList;->add(ILjava/lang/Object;)V

    .line 236
    iget-object v2, p0, Landroid/support/v4/app/ah;->c:Landroid/content/Context;

    invoke-virtual {v0}, Landroid/content/Intent;->getComponent()Landroid/content/ComponentName;

    move-result-object v0

    invoke-static {v2, v0}, Landroid/support/v4/app/w;->a(Landroid/content/Context;Landroid/content/ComponentName;)Landroid/content/Intent;
    :try_end_0
...
.method public a(Landroid/os/Bundle;)V
    ...
    iget-object v1, p0, Landroid/support/v4/app/ah;->b:Ljava/util/ArrayList;
    ...
    .line 321
    iget-object v1, p0, Landroid/support/v4/app/ah;->c:Landroid/content/Context;
