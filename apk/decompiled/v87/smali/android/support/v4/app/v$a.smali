...
# direct methods
.method public constructor <init>(Landroid/support/v4/app/v;ILandroid/os/Bundle;Landroid/support/v4/app/u$a;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I",
    ...
    .prologue
    .line 232
    iput-object p1, p0, Landroid/support/v4/app/v$a;->o:Landroid/support/v4/app/v;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    .line 233
    iput p2, p0, Landroid/support/v4/app/v$a;->a:I

    .line 234
    iput-object p3, p0, Landroid/support/v4/app/v$a;->b:Landroid/os/Bundle;

    .line 235
    iput-object p4, p0, Landroid/support/v4/app/v$a;->c:Landroid/support/v4/app/u$a;
...
.method a()V
    ...
    .line 255
    :cond_2
    iget-object v0, p0, Landroid/support/v4/app/v$a;->d:Landroid/support/v4/content/c;
    ...
    invoke-interface {v0, v1, v2}, Landroid/support/v4/app/u$a;->a(ILandroid/os/Bundle;)Landroid/support/v4/content/c;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/app/v$a;->d:Landroid/support/v4/content/c;
    ...
    iget-object v2, p0, Landroid/support/v4/app/v$a;->d:Landroid/support/v4/content/c;
    ...
    invoke-virtual {v0}, Landroid/support/v4/content/c;->k()V
...
.method public a(Landroid/support/v4/content/c;)V
    ...
    iget-object v0, v0, Landroid/support/v4/app/v;->b:Landroid/support/v4/f/o;
    ...
    .line 402
    :cond_4
    iput-object v4, p0, Landroid/support/v4/app/v$a;->n:Landroid/support/v4/app/v$a;

    .line 403
    iget-object v1, p0, Landroid/support/v4/app/v$a;->o:Landroid/support/v4/app/v;

    iget-object v1, v1, Landroid/support/v4/app/v;->b:Landroid/support/v4/f/o;

    iget v2, p0, Landroid/support/v4/app/v$a;->a:I

    invoke-virtual {v1, v2, v4}, Landroid/support/v4/f/o;->b(ILjava/lang/Object;)V

    .line 404
    invoke-virtual {p0}, Landroid/support/v4/app/v$a;->g()V

    .line 405
    iget-object v1, p0, Landroid/support/v4/app/v$a;->o:Landroid/support/v4/app/v;

    invoke-virtual {v1, v0}, Landroid/support/v4/app/v;->a(Landroid/support/v4/app/v$a;)V
...
.method public a(Landroid/support/v4/content/c;Ljava/lang/Object;)V
    ...
    .line 441
    :cond_6
    iput-object p2, p0, Landroid/support/v4/app/v$a;->g:Ljava/lang/Object;

    .line 442
    const/4 v0, 0x1

    iput-boolean v0, p0, Landroid/support/v4/app/v$a;->e:Z
    ...
    .line 444
    invoke-virtual {p0, p1, p2}, Landroid/support/v4/app/v$a;->b(Landroid/support/v4/content/c;Ljava/lang/Object;)V

    .line 454
    :cond_7
    iget-object v0, p0, Landroid/support/v4/app/v$a;->o:Landroid/support/v4/app/v;

    iget-object v0, v0, Landroid/support/v4/app/v;->c:Landroid/support/v4/f/o;
    ...
    iput-boolean v1, v0, Landroid/support/v4/app/v$a;->f:Z
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/f/o;->c(I)V

    .line 461
    :cond_8
    iget-object v0, p0, Landroid/support/v4/app/v$a;->o:Landroid/support/v4/app/v;

    iget-object v0, v0, Landroid/support/v4/app/v;->h:Landroid/support/v4/app/l;
...
.method b(Landroid/support/v4/content/c;Ljava/lang/Object;)V
    ...
    iget-object v1, v1, Landroid/support/v4/app/v;->h:Landroid/support/v4/app/l;
    ...
    .line 475
    invoke-virtual {p1, p2}, Landroid/support/v4/content/c;->c(Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v4/app/u$a;->a(Landroid/support/v4/content/c;Ljava/lang/Object;)V
    :try_end_0
    ...
    iget-object v2, v2, Landroid/support/v4/app/v;->h:Landroid/support/v4/app/l;
...
.method c()V
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/v4/app/v$a;->b(Landroid/support/v4/content/c;Ljava/lang/Object;)V
...
.method f()Z
    ...
    invoke-virtual {v0}, Landroid/support/v4/content/c;->m()Z
    ...
    .line 337
    iget-object v1, p0, Landroid/support/v4/app/v$a;->d:Landroid/support/v4/content/c;

    invoke-virtual {p0, v1}, Landroid/support/v4/app/v$a;->a(Landroid/support/v4/content/c;)V
...
.method g()V
    ...
    iget-object v3, p0, Landroid/support/v4/app/v$a;->d:Landroid/support/v4/content/c;

    invoke-interface {v0, v3}, Landroid/support/v4/app/u$a;->a(Landroid/support/v4/content/c;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
