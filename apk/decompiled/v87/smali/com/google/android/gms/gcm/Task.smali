...
.field private final zzias:Ljava/lang/String;

.field private final zziat:Z

.field private final zziau:Z

.field private final zziav:I

.field private final zziaw:Z

.field private final zziax:Z

.field private final zziay:Lcom/google/android/gms/gcm/m;
...
.method constructor <init>(Landroid/os/Parcel;)V
    ...
    iput-object v0, p0, Lcom/google/android/gms/gcm/Task;->zzias:Ljava/lang/String;
    ...
    :goto_0
    iput-boolean v0, p0, Lcom/google/android/gms/gcm/Task;->zziat:Z
    ...
    :goto_1
    iput-boolean v1, p0, Lcom/google/android/gms/gcm/Task;->zziau:Z

    const/4 v0, 0x2

    iput v0, p0, Lcom/google/android/gms/gcm/Task;->zziav:I

    iput-boolean v2, p0, Lcom/google/android/gms/gcm/Task;->zziaw:Z

    iput-boolean v2, p0, Lcom/google/android/gms/gcm/Task;->zziax:Z

    sget-object v0, Lcom/google/android/gms/gcm/m;->a:Lcom/google/android/gms/gcm/m;

    iput-object v0, p0, Lcom/google/android/gms/gcm/Task;->zziay:Lcom/google/android/gms/gcm/m;
...
.method constructor <init>(Lcom/google/android/gms/gcm/Task$a;)V
    ...
    iput-boolean v0, p0, Lcom/google/android/gms/gcm/Task;->zziau:Z
    ...
    iput-boolean v0, p0, Lcom/google/android/gms/gcm/Task;->zziaw:Z

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/google/android/gms/gcm/Task;->zziax:Z

    iget-object v0, p1, Lcom/google/android/gms/gcm/Task$a;->h:Landroid/os/Bundle;

    iput-object v0, p0, Lcom/google/android/gms/gcm/Task;->mExtras:Landroid/os/Bundle;

    iget-object v0, p1, Lcom/google/android/gms/gcm/Task$a;->g:Lcom/google/android/gms/gcm/m;
...
.method public getRequiredNetwork()I
    ...
    iget v0, p0, Lcom/google/android/gms/gcm/Task;->zziav:I
...
.method public getRequiresCharging()Z
    ...
    iget-boolean v0, p0, Lcom/google/android/gms/gcm/Task;->zziaw:Z
...
.method public getServiceName()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/google/android/gms/gcm/Task;->zzias:Ljava/lang/String;
...
.method public isPersisted()Z
    ...
    iget-boolean v0, p0, Lcom/google/android/gms/gcm/Task;->zziau:Z
...
.method public isUpdateCurrent()Z
    ...
    iget-boolean v0, p0, Lcom/google/android/gms/gcm/Task;->zziat:Z
...
.method public toBundle(Landroid/os/Bundle;)V
    ...
    iget-boolean v1, p0, Lcom/google/android/gms/gcm/Task;->zziat:Z

    invoke-virtual {p1, v0, v1}, Landroid/os/Bundle;->putBoolean(Ljava/lang/String;Z)V

    const-string v0, "persisted"

    iget-boolean v1, p0, Lcom/google/android/gms/gcm/Task;->zziau:Z

    invoke-virtual {p1, v0, v1}, Landroid/os/Bundle;->putBoolean(Ljava/lang/String;Z)V

    const-string v0, "service"

    iget-object v1, p0, Lcom/google/android/gms/gcm/Task;->zzias:Ljava/lang/String;

    invoke-virtual {p1, v0, v1}, Landroid/os/Bundle;->putString(Ljava/lang/String;Ljava/lang/String;)V

    const-string v0, "requiredNetwork"

    iget v1, p0, Lcom/google/android/gms/gcm/Task;->zziav:I

    invoke-virtual {p1, v0, v1}, Landroid/os/Bundle;->putInt(Ljava/lang/String;I)V

    const-string v0, "requiresCharging"

    iget-boolean v1, p0, Lcom/google/android/gms/gcm/Task;->zziaw:Z
    ...
    iget-object v1, p0, Lcom/google/android/gms/gcm/Task;->zziay:Lcom/google/android/gms/gcm/m;

    new-instance v2, Landroid/os/Bundle;

    invoke-direct {v2}, Landroid/os/Bundle;-><init>()V

    invoke-virtual {v1, v2}, Lcom/google/android/gms/gcm/m;->a(Landroid/os/Bundle;)Landroid/os/Bundle;
