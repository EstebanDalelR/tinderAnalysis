...
.method public static final synthetic a(Lcom/tinder/data/profile/client/a;I)V
    .locals 0

    .prologue
    .line 15
    invoke-direct {p0, p1}, Lcom/tinder/data/profile/client/a;->a(I)V
...
.method public static final synthetic b(Lcom/tinder/data/profile/client/a;I)V
    .locals 0

    .prologue
    .line 15
    invoke-direct {p0, p1}, Lcom/tinder/data/profile/client/a;->b(I)V
...
.method public final a()Lio/reactivex/a;
    ...
    invoke-interface {v0}, Lcom/tinder/api/TinderUserApi;->deleteUsername()Lio/reactivex/u;

    move-result-object v1

    .line 37
    sget-object v0, Lcom/tinder/data/profile/client/a$b;->a:Lcom/tinder/data/profile/client/a$b;
    ...
    check-cast p0, Lcom/tinder/data/profile/client/a;

    invoke-direct {v0, p0}, Lcom/tinder/data/profile/client/WebProfileClient$delete$2;-><init>(Lcom/tinder/data/profile/client/a;)V

    check-cast v0, Lkotlin/jvm/a/b;

    new-instance v1, Lcom/tinder/data/profile/client/b;

    invoke-direct {v1, v0}, Lcom/tinder/data/profile/client/b;-><init>(Lkotlin/jvm/a/b;)V

    move-object v0, v1

    check-cast v0, Lio/reactivex/b/h;

    invoke-virtual {v2, v0}, Lio/reactivex/u;->c(Lio/reactivex/b/h;)Lio/reactivex/u;

    move-result-object v0

    .line 39
    invoke-virtual {v0}, Lio/reactivex/u;->b()Lio/reactivex/a;
...
.method public final a(Ljava/lang/String;)Lio/reactivex/a;
    ...
    .line 21
    iget-object v1, p0, Lcom/tinder/data/profile/client/a;->a:Lcom/tinder/api/TinderUserApi;

    invoke-interface {v1, v0}, Lcom/tinder/api/TinderUserApi;->createUsername(Lcom/tinder/api/model/profile/UpdateUsernameRequestBody;)Lio/reactivex/u;

    move-result-object v1

    .line 22
    sget-object v0, Lcom/tinder/data/profile/client/a$a;->a:Lcom/tinder/data/profile/client/a$a;
    ...
    invoke-direct {v0, p0}, Lcom/tinder/data/profile/client/WebProfileClient$create$2;-><init>(Lcom/tinder/data/profile/client/a;)V
...
.method public final b(Ljava/lang/String;)Lio/reactivex/a;
    ...
    invoke-interface {v1, v0}, Lcom/tinder/api/TinderUserApi;->updateUsername(Lcom/tinder/api/model/profile/UpdateUsernameRequestBody;)Lio/reactivex/u;

    move-result-object v1

    .line 30
    sget-object v0, Lcom/tinder/data/profile/client/a$c;->a:Lcom/tinder/data/profile/client/a$c;
    ...
    invoke-direct {v0, p0}, Lcom/tinder/data/profile/client/WebProfileClient$update$2;-><init>(Lcom/tinder/data/profile/client/a;)V
