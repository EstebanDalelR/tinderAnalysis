...
# instance fields
.field private final schedulerObserveOn:Lio/reactivex/t;

.field private final schedulerSubscribeOn:Lio/reactivex/t;
...
.method private constructor <init>(Lio/reactivex/t;Lio/reactivex/t;)V
    .locals 0
    ...
    iput-object p1, p0, Lcom/tinder/domain/common/reactivex/RxUtils$SchedulersTransformer;->schedulerSubscribeOn:Lio/reactivex/t;

    iput-object p2, p0, Lcom/tinder/domain/common/reactivex/RxUtils$SchedulersTransformer;->schedulerObserveOn:Lio/reactivex/t;

    return-void
.end method

.method public synthetic constructor <init>(Lio/reactivex/t;Lio/reactivex/t;Lkotlin/jvm/internal/f;)V
    .locals 0

    .prologue
    .line 28
    invoke-direct {p0, p1, p2}, Lcom/tinder/domain/common/reactivex/RxUtils$SchedulersTransformer;-><init>(Lio/reactivex/t;Lio/reactivex/t;)V

    return-void
.end method

.method public static final synthetic access$getSchedulerObserveOn$p(Lcom/tinder/domain/common/reactivex/RxUtils$SchedulersTransformer;)Lio/reactivex/t;
    .locals 1

    .prologue
    .line 28
    iget-object v0, p0, Lcom/tinder/domain/common/reactivex/RxUtils$SchedulersTransformer;->schedulerObserveOn:Lio/reactivex/t;

    return-object v0
.end method

.method public static final synthetic access$getSchedulerSubscribeOn$p(Lcom/tinder/domain/common/reactivex/RxUtils$SchedulersTransformer;)Lio/reactivex/t;
    .locals 1

    .prologue
    .line 28
    iget-object v0, p0, Lcom/tinder/domain/common/reactivex/RxUtils$SchedulersTransformer;->schedulerSubscribeOn:Lio/reactivex/t;
...
# virtual methods
.method public apply(Lio/reactivex/l;)Lio/reactivex/q;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p1, v0}, Lio/reactivex/l;->subscribeOn(Lio/reactivex/t;)Lio/reactivex/l;

    move-result-object v0

    iget-object v1, p0, Lcom/tinder/domain/common/reactivex/RxUtils$SchedulersTransformer;->schedulerObserveOn:Lio/reactivex/t;
...
.method public final forSingle()Lio/reactivex/x;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<R:",
