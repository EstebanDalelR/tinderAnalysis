...
.method private a(Lio/reactivex/s;Ljava/util/concurrent/atomic/AtomicBoolean;)Lio/reactivex/b/g;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p1, p2}, Lio/reactivex/internal/operators/observable/ObservableRefCount$a;-><init>(Lio/reactivex/internal/operators/observable/ObservableRefCount;Lio/reactivex/s;Ljava/util/concurrent/atomic/AtomicBoolean;)V
...
# virtual methods
.method a(Lio/reactivex/s;Lio/reactivex/disposables/a;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p0, p1, p2, v0}, Lio/reactivex/internal/operators/observable/ObservableRefCount$ConnectionObserver;-><init>(Lio/reactivex/internal/operators/observable/ObservableRefCount;Lio/reactivex/s;Lio/reactivex/disposables/a;Lio/reactivex/disposables/b;)V
    ...
    invoke-virtual {v0, v1}, Lio/reactivex/c/a;->subscribe(Lio/reactivex/s;)V
...
.method public subscribeActual(Lio/reactivex/s;)V
    ...
    invoke-direct {p0, p1, v1}, Lio/reactivex/internal/operators/observable/ObservableRefCount;->a(Lio/reactivex/s;Ljava/util/concurrent/atomic/AtomicBoolean;)Lio/reactivex/b/g;

    move-result-object v2

    invoke-virtual {v0, v2}, Lio/reactivex/c/a;->a(Lio/reactivex/b/g;)V
    :try_end_0
    ...
    invoke-virtual {p0, p1, v0}, Lio/reactivex/internal/operators/observable/ObservableRefCount;->a(Lio/reactivex/s;Lio/reactivex/disposables/a;)V
    :try_end_1
