...
.method public intercept(Lokhttp3/t$a;)Lokhttp3/aa;
    ...
    .line 58
    :cond_0
    invoke-virtual {v3}, Lokhttp3/z;->contentLength()J
    ...
    invoke-static {v3, v4, v5}, Lokhttp3/internal/b/e;->a(Lokhttp3/m;Lokhttp3/HttpUrl;Lokhttp3/s;)V
    ...
    invoke-virtual {v3}, Lokhttp3/ab;->source()Lokio/e;

    move-result-object v3

    invoke-direct {v0, v3}, Lokio/i;-><init>(Lokio/r;)V
    ...
    invoke-virtual {v3}, Lokhttp3/s;->c()Lokhttp3/s$a;
    ...
    .line 108
    invoke-virtual {v1, v3}, Lokhttp3/aa$a;->a(Lokhttp3/s;)Lokhttp3/aa$a;
    ...
    invoke-direct {v3, v2, v6, v7, v0}, Lokhttp3/internal/b/h;-><init>(Ljava/lang/String;JLokio/e;)V
