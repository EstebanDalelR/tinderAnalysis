...
.method public static a(Ljava/lang/Iterable;Lrx/functions/j;)Lrx/i;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<R:",
    ...
    .line 1419
    invoke-static {v0, p1}, Lrx/internal/operators/bo;->a([Lrx/i;Lrx/functions/j;)Lrx/i;
...
.method public static a(Lrx/i;)Lrx/i;
    ...
    invoke-virtual {p0, v0}, Lrx/internal/util/i;->h(Lrx/functions/f;)Lrx/i;
...
.method public static a(Lrx/i;Lrx/i;Lrx/functions/g;)Lrx/i;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T1:",
    ...
    invoke-direct {v1, p2}, Lrx/i$7;-><init>(Lrx/functions/g;)V

    invoke-static {v0, v1}, Lrx/internal/operators/bo;->a([Lrx/i;Lrx/functions/j;)Lrx/i;
...
.method public static a(Lrx/i;Lrx/i;Lrx/i;Lrx/functions/h;)Lrx/i;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T1:",
    ...
    invoke-direct {v1, p3}, Lrx/i$8;-><init>(Lrx/functions/h;)V
...
.method public final a(Lrx/functions/f;)Lrx/i;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<R:",
    ...
    invoke-virtual {p0, p1}, Lrx/internal/util/i;->h(Lrx/functions/f;)Lrx/i;
    ...
    :cond_0
    invoke-virtual {p0, p1}, Lrx/i;->d(Lrx/functions/f;)Lrx/i;
...
.method public final a(Lrx/i;Lrx/functions/g;)Lrx/i;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T2:",
    ...
    .prologue
    .line 2320
    invoke-static {p0, p1, p2}, Lrx/i;->a(Lrx/i;Lrx/i;Lrx/functions/g;)Lrx/i;
...
.method public final c(Lrx/functions/f;)Lrx/b;
    ...
    invoke-direct {v0, p0, p1}, Lrx/internal/operators/b;-><init>(Lrx/i;Lrx/functions/f;)V
...
.method public final d(Lrx/functions/f;)Lrx/i;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<R:",
    ...
    invoke-direct {v0, p0, p1}, Lrx/internal/operators/bm;-><init>(Lrx/i;Lrx/functions/f;)V
...
.method public final e(Lrx/functions/f;)Lrx/i;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, v1, p1}, Lrx/internal/operators/bk;-><init>(Lrx/i$a;Lrx/functions/f;)V
...
.method public final f(Lrx/functions/f;)Lrx/i;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p0, p1}, Lrx/internal/operators/bn;->a(Lrx/i;Lrx/functions/f;)Lrx/internal/operators/bn;
...
.method public final g(Lrx/functions/f;)Lrx/i;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
