    ...
    return (
      <div>
        ...
        <div>
          ...
          <p className='apktext'>It is widelly used to gather information about the connectivity. For example, this class,
            which uses the ReactiveNetwork library for bindings uses this permission.
          </p>
          <img src='resources/permissions4.png' alt='code snippet' width='90%' />
        </div>
        ...
        <div>
          ...
          <img src='resources/permissions0.png' alt='code snippet' width='90%' />
          <p className='apktext'>
            It is also used in when reading application info, metadata and storage keys.
          </p>
          <img src='resources/permissions5.png' alt='code snippet' width='90%' />
        </div>

        <div>
          <h3>WRITE_EXTERNAL_STORAGE</h3>
          <p className='apktext'>It is used when writing application info, like metadata and storage keys</p>
        </div>
        ...
        <div>
          ...
          <img src='resources/permissions1.png' alt='code snippet' width='90%' />
        </div>
